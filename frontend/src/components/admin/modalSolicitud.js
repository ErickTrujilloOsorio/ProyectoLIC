...
export default function ModalSolicitud({ isVisible, closeModal, data, handleSaveChanges, handleConfirmDelete, mode, fields, title }) {
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body mt-2">
                        {mode === 'edit' || mode === 'create' ? (
                            ...
                            <div>
                                <p>¿Estás seguro de que deseas eliminar {title} de {data[fields[0].name]}?</p>
                                <div className="modal-footer">
                                    <button type="button" className="btn btn-secondary btn-sm" onClick={handleCloseModal}>Cancelar</button>
